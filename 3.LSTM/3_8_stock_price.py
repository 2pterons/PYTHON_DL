# -*- coding: utf-8 -*-
"""3-8.stock_price(1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AIGis5Ldt9QpU-Y1eeN8xzecXHzTnt2-
"""

# LSTM을 이용한 주가 수익률 예측
# 주체별 매매 동향 데이터로 향후 주가 수익률을 추정한다.
#
# 생각해 보기 : 이 분석의 문제점은 무엇인가?
#
...
data = pd.read_csv('삼성전자.csv', encoding='euc-kr')
